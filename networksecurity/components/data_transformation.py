...
from networksecurity.entity.artifact_entity import (DataTransformationArtifact,DataIngestionArtifact)
...
class DataTransformation:
    ...
    def initiate_data_transformation(self)-> DataTransformationArtifact:
        ...
        try:
            ...
            transformed_input_test_feature=preprocessor_object.transform(target_feature_test_df)
